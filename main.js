...
function updateArray(){
  ...
  while(i < len){
      ...
      if((parseInt(current[3]) < ypos+140) && (parseInt(current[3]) > ypos-55) && (current[3]*current[1]+parseInt(current[4])) < xpos+50 && (current[3]* current[1]+parseInt(current[4])) > xpos-50 && (current[3]* current[1]+parseInt(current[4])) > 0 && (current[3]* current[1]+parseInt(current[4])) < gameField.width){
      	place = 3;
      }
